...
.field public static final K9_SETTINGS_MIME_TYPE:Ljava/lang/String; = "application/x-k9settings"

.field private static final MIME_TYPE_BY_EXTENSION_MAP:[[Ljava/lang/String;
...
.method public static closeInputStreamWithoutDeletingTemporaryFiles(Ljava/io/InputStream;)V
    .locals 1
    ...
    .prologue
    .line 1052
    instance-of v0, p0, Lcom/fsck/k9/mail/internet/BinaryTempFileBody$BinaryTempFileBodyInputStream;

    if-eqz v0, :cond_0

    .line 1053
    check-cast p0, Lcom/fsck/k9/mail/internet/BinaryTempFileBody$BinaryTempFileBodyInputStream;

    .end local p0    # "rawInputStream":Ljava/io/InputStream;
    invoke-virtual {p0}, Lcom/fsck/k9/mail/internet/BinaryTempFileBody$BinaryTempFileBodyInputStream;->closeWithoutDeleting()V
    ...
    .line 1055
    .restart local p0    # "rawInputStream":Ljava/io/InputStream;
    :cond_0
...
.method private static decode(Ljava/lang/String;Lcom/fsck/k9/mail/Message;)Ljava/lang/String;
    .locals 1
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/fsck/k9/mail/internet/DecoderUtil;->decodeEncodedWords(Ljava/lang/String;Lcom/fsck/k9/mail/Message;)Ljava/lang/String;
...
.method public static decodeBody(Lcom/fsck/k9/mail/Body;)Ljava/io/InputStream;
    .locals 7
    .param p0, "body"    # Lcom/fsck/k9/mail/Body;
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 1017
    instance-of v4, p0, Lcom/fsck/k9/mail/internet/RawDataBody;
    ...
    .line 1018
    check-cast v2, Lcom/fsck/k9/mail/internet/RawDataBody;

    .line 1019
    .local v2, "rawDataBody":Lcom/fsck/k9/mail/internet/RawDataBody;
    invoke-interface {v2}, Lcom/fsck/k9/mail/internet/RawDataBody;->getEncoding()Ljava/lang/String;

    move-result-object v0

    .line 1020
    .local v0, "encoding":Ljava/lang/String;
    invoke-interface {v2}, Lcom/fsck/k9/mail/internet/RawDataBody;->getInputStream()Ljava/io/InputStream;
    ...
    .end local v2    # "rawDataBody":Lcom/fsck/k9/mail/internet/RawDataBody;
    .end local v3    # "rawInputStream":Ljava/io/InputStream;
    ...
    .restart local v2    # "rawDataBody":Lcom/fsck/k9/mail/internet/RawDataBody;
    .restart local v3    # "rawInputStream":Ljava/io/InputStream;
    :cond_1
    ...
    .line 1025
    new-instance v1, Lcom/fsck/k9/mail/internet/MimeUtility$1;

    invoke-direct {v1, v3, v6, v3}, Lcom/fsck/k9/mail/internet/MimeUtility$1;-><init>(Ljava/io/InputStream;ZLjava/io/InputStream;)V
    ...
    .line 1033
    new-instance v1, Lcom/fsck/k9/mail/internet/MimeUtility$2;

    invoke-direct {v1, v3, v3}, Lcom/fsck/k9/mail/internet/MimeUtility$2;-><init>(Ljava/io/InputStream;Ljava/io/InputStream;)V
    ...
    .end local v1    # "inputStream":Ljava/io/InputStream;
    :cond_3
    const-string v4, "Unsupported encoding: %s"
    ...
    .end local v3    # "rawInputStream":Ljava/io/InputStream;
    :cond_4
    invoke-interface {p0}, Lcom/fsck/k9/mail/Body;->getInputStream()Ljava/io/InputStream;
...
.method public static findFirstPartByMimeType(Lcom/fsck/k9/mail/Part;Ljava/lang/String;)Lcom/fsck/k9/mail/Part;
    ...
    instance-of v3, v3, Lcom/fsck/k9/mail/Multipart;
    ...
    invoke-static {v3, p1}, Lcom/fsck/k9/mail/internet/MimeUtility;->isSameMimeType(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static getAllHeaderParameters(Ljava/lang/String;)Ljava/util/Map;
    .locals 12
    ...
    .line 964
    .local v3, "partParts":[Ljava/lang/String;
    array-length v9, v3
    ...
    .end local v1    # "parameterValue":Ljava/lang/String;
    :cond_0
    ...
    .end local v3    # "partParts":[Ljava/lang/String;
    :cond_1
    return-object v5
.end method

.method public static getEncodingforType(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    ...
    invoke-static {p0, v0}, Lcom/fsck/k9/mail/internet/MimeUtility;->isSameMimeType(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-static {p0}, Lcom/fsck/k9/mail/internet/MimeUtility;->isMessage(Ljava/lang/String;)Z
    ...
    .line 1117
    :cond_3
    invoke-static {p0}, Lcom/fsck/k9/mail/internet/MimeUtility;->isMultipart(Ljava/lang/String;)Z
...
.method public static getExtensionByMimeType(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1084
    .local v1, "lowerCaseMimeType":Ljava/lang/String;
    sget-object v4, Lcom/fsck/k9/mail/internet/MimeUtility;->MIME_TYPE_BY_EXTENSION_MAP:[[Ljava/lang/String;
    ...
    .line 1084
    .restart local v0    # "contentTypeMapEntry":[Ljava/lang/String;
    :cond_0
...
.method public static getMimeTypeByExtension(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lcom/fsck/k9/mail/internet/MimeUtility;->isSameMimeType(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 1072
    sget-object v5, Lcom/fsck/k9/mail/internet/MimeUtility;->MIME_TYPE_BY_EXTENSION_MAP:[[Ljava/lang/String;
...
.method public static isDefaultMimeType(Ljava/lang/String;)Z
    .locals 1
    .param p0, "mimeType"    # Ljava/lang/String;
...
.method public static unfoldAndDecode(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/fsck/k9/mail/internet/MimeUtility;->unfoldAndDecode(Ljava/lang/String;Lcom/fsck/k9/mail/Message;)Ljava/lang/String;
...
.method public static unfoldAndDecode(Ljava/lang/String;Lcom/fsck/k9/mail/Message;)Ljava/lang/String;
    .locals 1
    .param p0, "s"    # Ljava/lang/String;
    .param p1, "message"    # Lcom/fsck/k9/mail/Message;
    ...
    invoke-static {v0, p1}, Lcom/fsck/k9/mail/internet/MimeUtility;->decode(Ljava/lang/String;Lcom/fsck/k9/mail/Message;)Ljava/lang/String;
