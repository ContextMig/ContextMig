...
.method private parse()V
    ...
    iput-boolean v3, p0, Lorg/apache/james/mime4j/field/ContentLanguageFieldImpl;->parsed:Z
    ...
    iput-object v3, p0, Lorg/apache/james/mime4j/field/ContentLanguageFieldImpl;->languages:Ljava/util/List;
    ...
    .line 52
    new-instance v2, Lorg/apache/james/mime4j/field/language/parser/ContentLanguageParser;

    new-instance v3, Ljava/io/StringReader;

    invoke-direct {v3, v0}, Ljava/io/StringReader;-><init>(Ljava/lang/String;)V

    invoke-direct {v2, v3}, Lorg/apache/james/mime4j/field/language/parser/ContentLanguageParser;-><init>(Ljava/io/Reader;)V

    .line 54
    .local v2, "parser":Lorg/apache/james/mime4j/field/language/parser/ContentLanguageParser;
    :try_start_0
    invoke-virtual {v2}, Lorg/apache/james/mime4j/field/language/parser/ContentLanguageParser;->parse()Ljava/util/List;
    ...
    .line 59
    .end local v2    # "parser":Lorg/apache/james/mime4j/field/language/parser/ContentLanguageParser;
    :cond_0
    :goto_0
    return-void

    .line 55
    .restart local v2    # "parser":Lorg/apache/james/mime4j/field/language/parser/ContentLanguageParser;
    :catch_0
    move-exception v1

    .line 56
    .local v1, "ex":Lorg/apache/james/mime4j/field/language/parser/ParseException;
    iput-object v1, p0, Lorg/apache/james/mime4j/field/ContentLanguageFieldImpl;->parseException:Lorg/apache/james/mime4j/field/language/parser/ParseException;
