...
.method public constructor <init>(Lorg/apache/james/mime4j/dom/Entity;Lorg/apache/james/mime4j/message/BodyFactory;)V
    ...
    .param p2, "bodyFactory"    # Lorg/apache/james/mime4j/message/BodyFactory;
...
.method public constructor <init>(Lorg/apache/james/mime4j/dom/Entity;Lorg/apache/james/mime4j/message/MessageImplFactory;Lorg/apache/james/mime4j/message/BodyFactory;)V
    .locals 1
    .param p1, "entity"    # Lorg/apache/james/mime4j/dom/Entity;
    .param p2, "messageImplFactory"    # Lorg/apache/james/mime4j/message/MessageImplFactory;
    .param p3, "bodyFactory"    # Lorg/apache/james/mime4j/message/BodyFactory;
...
.method public body(Lorg/apache/james/mime4j/stream/BodyDescriptor;Ljava/io/InputStream;)V
    ...
    .prologue
    .line 125
    const-class v2, Lorg/apache/james/mime4j/dom/Entity;

    invoke-direct {p0, v2}, Lorg/apache/james/mime4j/internal/ParserStreamContentHandler;->expect(Ljava/lang/Class;)V
    ...
    .line 129
    iget-object v2, p0, Lorg/apache/james/mime4j/internal/ParserStreamContentHandler;->bodyFactory:Lorg/apache/james/mime4j/message/BodyFactory;

    invoke-interface {p1}, Lorg/apache/james/mime4j/stream/BodyDescriptor;->getCharset()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, p2, v3}, Lorg/apache/james/mime4j/message/BodyFactory;->textBody(Ljava/io/InputStream;Ljava/lang/String;)Lorg/apache/james/mime4j/dom/TextBody;
    ...
    .line 135
    .local v1, "entity":Lorg/apache/james/mime4j/dom/Entity;
    ...
    .end local v1    # "entity":Lorg/apache/james/mime4j/dom/Entity;
    :cond_0
    iget-object v2, p0, Lorg/apache/james/mime4j/internal/ParserStreamContentHandler;->bodyFactory:Lorg/apache/james/mime4j/message/BodyFactory;

    invoke-interface {v2, p2}, Lorg/apache/james/mime4j/message/BodyFactory;->binaryBody(Ljava/io/InputStream;)Lorg/apache/james/mime4j/dom/BinaryBody;
...
.method public endHeader()V
    ...
    .prologue
    .line 108
    const-class v1, Lorg/apache/james/mime4j/dom/Header;
    ...
    .line 110
    .local v0, "h":Lorg/apache/james/mime4j/dom/Header;
...
.method public epilogue(Ljava/io/InputStream;)V
    ...
    .prologue
    .line 156
    const-class v1, Lorg/apache/james/mime4j/message/MultipartImpl;
    ...
    invoke-virtual {v1, v0}, Lorg/apache/james/mime4j/message/MultipartImpl;->setEpilogueRaw(Lorg/apache/james/mime4j/util/ByteSequence;)V
...
.method public preamble(Ljava/io/InputStream;)V
    ...
    invoke-virtual {v1, v0}, Lorg/apache/james/mime4j/message/MultipartImpl;->setPreambleRaw(Lorg/apache/james/mime4j/util/ByteSequence;)V
...
.method public startBodyPart()V
    ...
    .prologue
    .line 143
    const-class v1, Lorg/apache/james/mime4j/dom/Multipart;
...
.method public startMessage()V
    ...
    iget-object v2, p0, Lorg/apache/james/mime4j/internal/ParserStreamContentHandler;->entity:Lorg/apache/james/mime4j/dom/Entity;
    ...
    .line 87
    iget-object v1, p0, Lorg/apache/james/mime4j/internal/ParserStreamContentHandler;->messageImplFactory:Lorg/apache/james/mime4j/message/MessageImplFactory;

    invoke-interface {v1}, Lorg/apache/james/mime4j/message/MessageImplFactory;->messageImpl()Lorg/apache/james/mime4j/message/MessageImpl;

    move-result-object v0

    .line 88
    .local v0, "m":Lorg/apache/james/mime4j/dom/Message;
    iget-object v1, p0, Lorg/apache/james/mime4j/internal/ParserStreamContentHandler;->stack:Ljava/util/Stack;
...
.method public startMultipart(Lorg/apache/james/mime4j/stream/BodyDescriptor;)V
    ...
    .prologue
    .line 115
    const-class v3, Lorg/apache/james/mime4j/dom/Entity;

    invoke-direct {p0, v3}, Lorg/apache/james/mime4j/internal/ParserStreamContentHandler;->expect(Ljava/lang/Class;)V

    .line 117
    iget-object v3, p0, Lorg/apache/james/mime4j/internal/ParserStreamContentHandler;->stack:Ljava/util/Stack;
    ...
    .line 118
    .local v0, "e":Lorg/apache/james/mime4j/dom/Entity;
    ...
    invoke-direct {v1, v2}, Lorg/apache/james/mime4j/message/MultipartImpl;-><init>(Ljava/lang/String;)V

    .line 120
    .local v1, "multiPart":Lorg/apache/james/mime4j/dom/Multipart;
