...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 141
    check-cast v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;

    .line 142
    .local v0, "other":Lorg/apache/james/mime4j/dom/datetime/DateTime;
    iget-object v3, p0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->date:Ljava/util/Date;

    if-nez v3, :cond_3

    .line 143
    iget-object v3, v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->date:Ljava/util/Date;

    if-nez v3, :cond_0

    .line 147
    :cond_2
    iget v3, p0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->day:I

    iget v4, v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->day:I

    if-ne v3, v4, :cond_0

    .line 149
    iget v3, p0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->hour:I

    iget v4, v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->hour:I

    if-ne v3, v4, :cond_0

    .line 151
    iget v3, p0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->minute:I

    iget v4, v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->minute:I

    if-ne v3, v4, :cond_0

    .line 153
    iget v3, p0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->month:I

    iget v4, v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->month:I

    if-ne v3, v4, :cond_0

    .line 155
    iget v3, p0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->second:I

    iget v4, v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->second:I

    if-ne v3, v4, :cond_0

    .line 157
    iget v3, p0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->timeZone:I

    iget v4, v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->timeZone:I

    if-ne v3, v4, :cond_0

    .line 159
    iget v3, p0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->year:I

    iget v4, v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->year:I
    ...
    iget-object v4, v0, Lorg/apache/james/mime4j/dom/datetime/DateTime;->date:Ljava/util/Date;
