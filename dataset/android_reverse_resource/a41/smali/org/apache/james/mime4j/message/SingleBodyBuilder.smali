...
.method public static createCopy(Lorg/apache/james/mime4j/dom/SingleBody;)Lorg/apache/james/mime4j/message/SingleBodyBuilder;
    .locals 1
    .param p0, "other"    # Lorg/apache/james/mime4j/dom/SingleBody;
...
.method public buildBinary()Lorg/apache/james/mime4j/dom/BinaryBody;
    ...
    .line 137
    iget-object v1, p0, Lorg/apache/james/mime4j/message/SingleBodyBuilder;->charset:Ljava/nio/charset/Charset;
    ...
    invoke-virtual {v1, v2}, Lorg/apache/james/mime4j/message/BasicBodyFactory;->binaryBody([B)Lorg/apache/james/mime4j/dom/BinaryBody;
...
.method public buildText()Lorg/apache/james/mime4j/dom/TextBody;
    ...
    invoke-interface {v1, v2, v3}, Lorg/apache/james/mime4j/message/BodyFactory;->textBody(Ljava/io/InputStream;Ljava/lang/String;)Lorg/apache/james/mime4j/dom/TextBody;
...
.method public copy(Lorg/apache/james/mime4j/dom/SingleBody;)Lorg/apache/james/mime4j/message/SingleBodyBuilder;
    .locals 3
    .param p1, "other"    # Lorg/apache/james/mime4j/dom/SingleBody;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
    ...
    .line 99
    :cond_0
    instance-of v2, p1, Lorg/apache/james/mime4j/dom/TextBody;
    ...
    .line 100
    check-cast v2, Lorg/apache/james/mime4j/dom/TextBody;

    invoke-virtual {v2}, Lorg/apache/james/mime4j/dom/TextBody;->getMimeCharset()Ljava/lang/String;
    ...
    iput-object v2, p0, Lorg/apache/james/mime4j/message/SingleBodyBuilder;->charset:Ljava/nio/charset/Charset;
    :try_end_0
    ...
    invoke-static {v2}, Lorg/apache/james/mime4j/util/ContentUtil;->buffer(Ljava/io/InputStream;)[B

    move-result-object v2

    iput-object v2, p0, Lorg/apache/james/mime4j/message/SingleBodyBuilder;->bin:[B
    ...
    .line 106
    .end local v1    # "ex":Ljava/nio/charset/IllegalCharsetNameException;
    :catch_1
    move-exception v1
