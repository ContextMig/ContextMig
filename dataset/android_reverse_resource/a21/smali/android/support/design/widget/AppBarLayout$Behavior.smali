...
.field private d:Landroid/support/design/widget/bx;
...
.method private b(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->a()I
    ...
    :cond_0
    :goto_1
    invoke-static {v5}, Landroid/support/v4/i/bt;->u(Landroid/view/View;)Z
...
.method private b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    invoke-direct {p0, p2, v2}, Landroid/support/design/widget/AppBarLayout$Behavior;->a(Landroid/support/design/widget/AppBarLayout;I)Landroid/view/View;
...
.method private b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/bx;
    ...
    iput-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/bx;
    ...
    invoke-virtual {v0, v1, p3}, Landroid/support/design/widget/bx;->a(II)V
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v2}, Landroid/support/design/widget/f;-><init>(Landroid/os/Parcelable;)V

    iput v3, v1, Landroid/support/design/widget/f;->a:I

    invoke-static {v6}, Landroid/support/v4/i/bt;->p(Landroid/view/View;)I
    ...
    :cond_0
    iput-boolean v0, v1, Landroid/support/design/widget/f;->c:Z
    ...
    iput v0, v1, Landroid/support/design/widget/f;->b:F
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/os/Parcelable;)V
    ...
    instance-of v0, p3, Landroid/support/design/widget/f;

    if-eqz v0, :cond_0

    check-cast p3, Landroid/support/design/widget/f;

    invoke-virtual {p3}, Landroid/support/design/widget/f;->getSuperState()Landroid/os/Parcelable;
    ...
    iget v0, p3, Landroid/support/design/widget/f;->a:I

    iput v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->e:I

    iget v0, p3, Landroid/support/design/widget/f;->b:F

    iput v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->g:F

    iget-boolean v0, p3, Landroid/support/design/widget/f;->c:Z
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Landroid/support/design/widget/al;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/os/Parcelable;)V
...
.method public bridge synthetic a(I)Z
    ...
    invoke-super {p0, p1}, Landroid/support/design/widget/al;->a(I)Z
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)Z
    ...
    invoke-super {p0, p1, p2, p3}, Landroid/support/design/widget/al;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-static {v0}, Landroid/support/v4/i/bt;->p(Landroid/view/View;)I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;Landroid/view/View;I)Z
    ...
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/bx;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/bx;

    invoke-virtual {v1}, Landroid/support/design/widget/bx;->e()V
...
.method public bridge synthetic b()I
    ...
    invoke-super {p0}, Landroid/support/design/widget/al;->b()I
