...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/r;->a()I
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->c:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->c:Landroid/graphics/Rect;

    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->c:Landroid/graphics/Rect;

    invoke-static {p1, p2, v0}, Landroid/support/design/widget/ci;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method private b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;)V
    ...
    iget v0, v0, Landroid/support/design/widget/r;->topMargin:I
...
.method private c(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;Landroid/view/View;)V
    ...
    iget v1, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:F

    cmpl-float v1, v1, v0

    if-eqz v1, :cond_0

    iput v0, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:F

    invoke-static {p2}, Landroid/support/v4/i/bt;->n(Landroid/view/View;)F
    ...
    invoke-static {p2}, Landroid/support/v4/i/bt;->q(Landroid/view/View;)Landroid/support/v4/i/di;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroid/support/v4/i/di;->c(F)Landroid/support/v4/i/di;

    move-result-object v0

    invoke-virtual {v0, v4}, Landroid/support/v4/i/di;->d(F)Landroid/support/v4/i/di;

    move-result-object v0

    invoke-virtual {v0, v4}, Landroid/support/v4/i/di;->e(F)Landroid/support/v4/i/di;
    ...
    invoke-virtual {v1}, Landroid/support/v4/i/di;->b()V

    invoke-static {p2, v0}, Landroid/support/v4/i/bt;->b(Landroid/view/View;F)V
