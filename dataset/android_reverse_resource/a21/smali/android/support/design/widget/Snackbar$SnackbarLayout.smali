...
.field private e:Landroid/support/design/widget/bf;

.field private f:Landroid/support/design/widget/be;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v1}, Landroid/support/v4/i/bt;->d(Landroid/view/View;F)V
    ...
    sget v1, Landroid/support/design/h;->design_layout_snackbar_include:I

    invoke-virtual {v0, v1, p0}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;)Landroid/view/View;

    invoke-static {p0, v3}, Landroid/support/v4/i/bt;->d(Landroid/view/View;I)V
...
.method private static a(Landroid/view/View;II)V
    ...
    invoke-static {p0}, Landroid/support/v4/i/bt;->x(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Landroid/support/v4/i/bt;->k(Landroid/view/View;)I

    move-result v0

    invoke-static {p0}, Landroid/support/v4/i/bt;->l(Landroid/view/View;)I

    move-result v1

    invoke-static {p0, v0, p1, v1, p2}, Landroid/support/v4/i/bt;->a(Landroid/view/View;IIII)V
...
.method a(II)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/i/di;->b(J)Landroid/support/v4/i/di;
...
.method b(II)V
    ...
    invoke-static {v0, v4}, Landroid/support/v4/i/bt;->c(Landroid/view/View;F)V
...
.method protected onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/be;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/be;

    invoke-interface {v0, p0}, Landroid/support/design/widget/be;->a(Landroid/view/View;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-interface {v0, p0}, Landroid/support/design/widget/be;->b(Landroid/view/View;)V
...
.method protected onFinishInflate()V
    ...
    sget v0, Landroid/support/design/g;->snackbar_text:I
    ...
    sget v0, Landroid/support/design/g;->snackbar_action:I
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bf;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/design/widget/bf;->a(Landroid/view/View;IIII)V
...
.method setOnAttachStateChangeListener(Landroid/support/design/widget/be;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/be;

    return-void
.end method

.method setOnLayoutChangeListener(Landroid/support/design/widget/bf;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bf;
