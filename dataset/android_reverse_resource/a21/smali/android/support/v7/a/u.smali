...
# interfaces
.implements Landroid/support/v4/b/bg;
...
.method public a(Landroid/support/v4/b/bf;)V
    .locals 0

    invoke-virtual {p1, p0}, Landroid/support/v4/b/bf;->a(Landroid/app/Activity;)Landroid/support/v4/b/bf;
...
.method public a(Landroid/content/Intent;)Z
    ...
    invoke-static {p0, p1}, Landroid/support/v4/b/ax;->a(Landroid/app/Activity;Landroid/content/Intent;)Z
...
.method public b(Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/b/ax;->b(Landroid/app/Activity;Landroid/content/Intent;)V

    return-void
.end method

.method public b(Landroid/support/v4/b/bf;)V
    .locals 0

    return-void
.end method

.method public b(Landroid/support/v7/e/a;)V
    .locals 0
...
.method public g()Z
    ...
    invoke-static {p0}, Landroid/support/v4/b/bf;->a(Landroid/content/Context;)Landroid/support/v4/b/bf;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroid/support/v7/a/u;->a(Landroid/support/v4/b/bf;)V

    invoke-virtual {p0, v0}, Landroid/support/v7/a/u;->b(Landroid/support/v4/b/bf;)V

    invoke-virtual {v0}, Landroid/support/v4/b/bf;->a()V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v4/b/r;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v4/b/r;->onMenuItemSelected(ILandroid/view/MenuItem;)Z
...
.method public onMenuOpened(ILandroid/view/Menu;)Z
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v4/b/r;->onMenuOpened(ILandroid/view/Menu;)Z
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v4/b/r;->onPanelClosed(ILandroid/view/Menu;)V
...
.method protected onPostCreate(Landroid/os/Bundle;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v4/b/r;->onPostCreate(Landroid/os/Bundle;)V
...
.method protected onPostResume()V
    ...
    invoke-super {p0}, Landroid/support/v4/b/r;->onPostResume()V
...
.method protected onTitleChanged(Ljava/lang/CharSequence;I)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v4/b/r;->onTitleChanged(Ljava/lang/CharSequence;I)V
