...
# direct methods
.method constructor <init>(Landroid/widget/CompoundButton;Landroid/support/v7/internal/widget/ao;)V
    .locals 2
    ...
    iput-object p1, p0, Landroid/support/v7/widget/x;->a:Landroid/widget/CompoundButton;

    iput-object p2, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/internal/widget/ao;
...
.method a(I)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->a:Landroid/widget/CompoundButton;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->c:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/x;->c:Landroid/content/res/ColorStateList;

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/widget/x;->e:Z

    invoke-virtual {p0}, Landroid/support/v7/widget/x;->d()V
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/x;->d:Landroid/graphics/PorterDuff$Mode;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/x;->a:Landroid/widget/CompoundButton;

    iget-object v3, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/internal/widget/ao;

    invoke-virtual {v3, v0}, Landroid/support/v7/internal/widget/ao;->a(I)Landroid/graphics/drawable/Drawable;
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->d:Landroid/graphics/PorterDuff$Mode;
...
.method d()V
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/x;->e:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Landroid/support/v7/widget/x;->f:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/x;->a:Landroid/widget/CompoundButton;
