...
.method private a(I)V
    ...
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/bp;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/bp;->f(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/bp;->c()V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/i/n;
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/bp;->m()Landroid/widget/ListView;
...
.method private getListPopupWindow()Landroid/support/v7/widget/bp;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/bp;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/bp;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->d:Landroid/support/v7/widget/bh;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/bh;->layout(IIII)V
...
.method public setProvider(Landroid/support/v4/i/n;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/i/n;
