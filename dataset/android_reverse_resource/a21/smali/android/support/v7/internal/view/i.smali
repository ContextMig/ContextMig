...
.field private d:Landroid/support/v4/i/dz;

.field private e:Z

.field private final f:Landroid/support/v4/i/ea;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/i;->f:Landroid/support/v4/i/ea;
...
.method static synthetic a(Landroid/support/v7/internal/view/i;)Landroid/support/v4/i/dz;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/view/i;->d:Landroid/support/v4/i/dz;
...
.method public a(Landroid/support/v4/i/di;)Landroid/support/v7/internal/view/i;
    .locals 1
...
.method public a(Landroid/support/v4/i/di;Landroid/support/v4/i/di;)Landroid/support/v7/internal/view/i;
    .locals 2
    ...
    invoke-virtual {p1}, Landroid/support/v4/i/di;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/i/di;->b(J)Landroid/support/v4/i/di;
...
.method public a(Landroid/support/v4/i/dz;)Landroid/support/v7/internal/view/i;
    .locals 1
    ...
    iput-object p1, p0, Landroid/support/v7/internal/view/i;->d:Landroid/support/v4/i/dz;
...
.method public a()V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/i/di;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/i/di;

    :cond_2
    iget-object v2, p0, Landroid/support/v7/internal/view/i;->d:Landroid/support/v4/i/dz;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/internal/view/i;->f:Landroid/support/v4/i/ea;
