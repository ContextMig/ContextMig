...
.field private u:Landroid/support/v4/widget/af;

.field private final x:Landroid/support/v4/i/bk;

.field private final y:Landroid/support/v4/i/bi;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v0, Landroid/support/v4/i/bk;

    invoke-direct {v0, p0}, Landroid/support/v4/i/bk;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/i/bk;

    new-instance v0, Landroid/support/v4/i/bi;

    invoke-direct {v0, p0}, Landroid/support/v4/i/bi;-><init>(Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/i/bi;
...
.method private a()V
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v4/widget/at;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/at;
...
.method public final a(II)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/at;

    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->getScrollX()I

    move-result v3

    invoke-virtual {v2, v3, v1, v4, v0}, Landroid/support/v4/widget/at;->a(IIII)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/at;

    invoke-virtual {v0}, Landroid/support/v4/widget/at;->a()Z
...
.method a(IIIIIIIIZ)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/at;
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/support/v4/widget/at;->a(IIIIII)Z
...
.method public computeScroll()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/at;->g()Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/at;->f()F
...
.method public d(I)V
    ...
    invoke-virtual/range {v0 .. v10}, Landroid/support/v4/widget/at;->a(IIIIIIIIII)V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/i/bi;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/i/bk;
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1, v1}, Landroid/support/v4/i/ay;->e(Landroid/view/MotionEvent;I)F
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/at;->a()Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/widget/at;->a(IIIIII)Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->u:Landroid/support/v4/widget/af;
    ...
    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->u:Landroid/support/v4/widget/af;

    iget v2, v2, Landroid/support/v4/widget/af;->a:I

    invoke-virtual {p0, v0, v2}, Landroid/support/v4/widget/NestedScrollView;->scrollTo(II)V

    iput-object v3, p0, Landroid/support/v4/widget/NestedScrollView;->u:Landroid/support/v4/widget/af;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/widget/af;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Landroid/widget/FrameLayout;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->u:Landroid/support/v4/widget/af;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Landroid/support/v4/widget/af;-><init>(Landroid/os/Parcelable;)V

    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->getScrollY()I

    move-result v0

    iput v0, v1, Landroid/support/v4/widget/af;->a:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/at;

    invoke-virtual {v2}, Landroid/support/v4/widget/at;->a()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/at;->h()V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/i/ay;->b(Landroid/view/MotionEvent;I)I
    ...
    invoke-static {v0, v2}, Landroid/support/v4/i/ay;->a(Landroid/view/MotionEvent;I)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/i/ay;->d(Landroid/view/MotionEvent;I)F
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/i/bt;->a(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/i/ay;->c(Landroid/view/MotionEvent;I)F
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/s;->b()Z
    ...
    :cond_10
    invoke-static/range {p0 .. p0}, Landroid/support/v4/i/bt;->d(Landroid/view/View;)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/i/bo;->b(Landroid/view/VelocityTracker;I)F
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/support/v4/widget/at;->a(IIIIII)Z
    ...
    :pswitch_5
    invoke-static/range {p1 .. p1}, Landroid/support/v4/i/ay;->b(Landroid/view/MotionEvent;)I

    move-result v2

    move-object/from16 v0, p1

    invoke-static {v0, v2}, Landroid/support/v4/i/ay;->d(Landroid/view/MotionEvent;I)F
