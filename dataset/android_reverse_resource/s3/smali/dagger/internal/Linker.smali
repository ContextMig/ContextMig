...
.method private createBinding(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/ClassLoader;Z)Ldagger/internal/Binding;
    ...
    const-string v5, "is a generic class or an array and can only be bound with concrete type parameter(s) in a @Provides method."
    ...
    const-string v5, "is a @Qualifier-annotated type and must be bound by a @Provides method."
...
.method public requestBinding(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/ClassLoader;ZZ)Ldagger/internal/Binding;
    ...
    .local v2, "linker":Ldagger/internal/Linker;
    :goto_0
    if-eqz v2, :cond_1

    .line 278
    iget-object v3, v2, Ldagger/internal/Linker;->bindings:Ljava/util/Map;
    ...
    .line 287
    new-instance v1, Ldagger/internal/Linker$DeferredBinding;

    invoke-direct {v1, p1, p3, p2, p4}, Ldagger/internal/Linker$DeferredBinding;-><init>(Ljava/lang/String;Ljava/lang/ClassLoader;Ljava/lang/Object;Z)V

    .line 289
    .local v1, "deferredBinding":Ldagger/internal/Binding;, "Ldagger/internal/Binding<*>;"
    invoke-virtual {v1, p5}, Ldagger/internal/Binding;->setLibrary(Z)V

    .line 290
    invoke-virtual {v1, v4}, Ldagger/internal/Binding;->setDependedOn(Z)V
    ...
    iput-boolean v3, p0, Ldagger/internal/Linker;->attachSuccess:Z
    ...
    .line 302
    .end local v0    # "binding":Ldagger/internal/Binding;, "Ldagger/internal/Binding<*>;"
    .end local v1    # "deferredBinding":Ldagger/internal/Binding;, "Ldagger/internal/Binding<*>;"
    :goto_1
    return-object v0
    ...
    .line 301
    invoke-virtual {v0, v4}, Ldagger/internal/Binding;->setDependedOn(Z)V
