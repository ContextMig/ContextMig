.class Lcom/dropbox/sync/android/DbxFileSystem$ChooserFactory;
...
.method synthetic constructor <init>(Lcom/dropbox/sync/android/DbxFileSystem$1;)V
    ...
    .prologue
    .line 266
    invoke-direct {p0}, Lcom/dropbox/sync/android/DbxFileSystem$ChooserFactory;-><init>()V
...
.method public bridge synthetic create(Lcom/dropbox/sync/android/DbxAccount;Lcom/dropbox/sync/android/NativeApp;Ljava/io/File;)Lcom/dropbox/sync/android/CoreClient;
    ...
    .prologue
    .line 266
    invoke-virtual {p0, p1, p2, p3}, Lcom/dropbox/sync/android/DbxFileSystem$ChooserFactory;->create(Lcom/dropbox/sync/android/DbxAccount;Lcom/dropbox/sync/android/NativeApp;Ljava/io/File;)Lcom/dropbox/sync/android/DbxFileSystem;
...
.method public create(Lcom/dropbox/sync/android/DbxAccount;Lcom/dropbox/sync/android/NativeApp;Ljava/io/File;)Lcom/dropbox/sync/android/DbxFileSystem;
    ...
    .prologue
    .line 275
    sget-object v0, Lcom/dropbox/sync/android/NativeFileSystem$ClientFlags;->PARTIAL_METADATA:Lcom/dropbox/sync/android/NativeFileSystem$ClientFlags;
    ...
    .line 276
    .local v4, "flags":Ljava/util/EnumSet;, "Ljava/util/EnumSet<Lcom/dropbox/sync/android/NativeFileSystem$ClientFlags;>;"
...
.method public getCacheDirTag()Ljava/lang/String;
    ...
    .prologue
    .line 269
    const-string v0, "chooser_filesystem"
