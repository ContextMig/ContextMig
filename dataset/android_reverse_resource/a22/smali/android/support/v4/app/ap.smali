...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/ap;->a:Landroid/support/v4/app/aq;
...
.method public static a(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    sget-object v0, Landroid/support/v4/app/ap;->a:Landroid/support/v4/app/aq;

    invoke-interface {v0, p0}, Landroid/support/v4/app/aq;->a(Landroid/app/Activity;)Landroid/content/Intent;
...
.method public static a(Landroid/app/Activity;Landroid/content/Intent;)Z
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/app/aq;->a(Landroid/app/Activity;Landroid/content/Intent;)Z
...
.method public static b(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    ...
    sget-object v1, Landroid/support/v4/app/ap;->a:Landroid/support/v4/app/aq;

    invoke-interface {v1, p0, v0}, Landroid/support/v4/app/aq;->a(Landroid/content/Context;Landroid/content/pm/ActivityInfo;)Ljava/lang/String;
...
.method public static b(Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/app/aq;->b(Landroid/app/Activity;Landroid/content/Intent;)V
