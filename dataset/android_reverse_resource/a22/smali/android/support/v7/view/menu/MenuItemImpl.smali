...
# instance fields
.field private mActionProvider:Landroid/support/v4/view/j;
...
.field private mOnActionExpandListener:Landroid/support/v4/view/ay;
...
.method public collapseActionView()Z
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mOnActionExpandListener:Landroid/support/v4/view/ay;

    if-eqz v1, :cond_3

    iget-object v1, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mOnActionExpandListener:Landroid/support/v4/view/ay;

    invoke-interface {v1, p0}, Landroid/support/v4/view/ay;->onMenuItemActionCollapse(Landroid/view/MenuItem;)Z
...
.method public expandActionView()Z
    ...
    invoke-interface {v1, p0}, Landroid/support/v4/view/ay;->onMenuItemActionExpand(Landroid/view/MenuItem;)Z
...
.method public getActionView()Landroid/view/View;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mActionProvider:Landroid/support/v4/view/j;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mActionProvider:Landroid/support/v4/view/j;

    invoke-virtual {v0, p0}, Landroid/support/v4/view/j;->onCreateActionView(Landroid/view/MenuItem;)Landroid/view/View;
...
.method public getSupportActionProvider()Landroid/support/v4/view/j;
    .locals 1
...
.method public hasCollapsibleActionView()Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mActionProvider:Landroid/support/v4/view/j;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mActionProvider:Landroid/support/v4/view/j;

    invoke-virtual {v1, p0}, Landroid/support/v4/view/j;->onCreateActionView(Landroid/view/MenuItem;)Landroid/view/View;
...
.method public invoke()Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/view/j;->onPerformDefaultAction()Z
...
.method public isVisible()Z
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mActionProvider:Landroid/support/v4/view/j;

    if-eqz v2, :cond_2

    iget-object v2, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mActionProvider:Landroid/support/v4/view/j;

    invoke-virtual {v2}, Landroid/support/v4/view/j;->overridesItemVisibility()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/j;->isVisible()Z
...
.method public setActionView(Landroid/view/View;)Landroid/support/v4/d/a/b;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mActionProvider:Landroid/support/v4/view/j;
...
.method public setSupportActionProvider(Landroid/support/v4/view/j;)Landroid/support/v4/d/a/b;
    .locals 2
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/j;->reset()V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mActionProvider:Landroid/support/v4/view/j;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/j;->setVisibilityListener(Landroid/support/v4/view/l;)V

    :cond_1
    return-object p0
.end method

.method public setSupportOnActionExpandListener(Landroid/support/v4/view/ay;)Landroid/support/v4/d/a/b;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/view/menu/MenuItemImpl;->mOnActionExpandListener:Landroid/support/v4/view/ay;
