...
.method public updatePackagesI(Lcom/adjust/sdk/SessionParameters;)V
    ...
    const-string v6, "Updating package handler queue"
    ...
    iget-object v8, p1, Lcom/adjust/sdk/SessionParameters;->callbackParameters:Ljava/util/Map;
    ...
    const-string v6, "Session partner parameters: %s"

    new-array v7, v10, [Ljava/lang/Object;

    iget-object v8, p1, Lcom/adjust/sdk/SessionParameters;->partnerParameters:Ljava/util/Map;
    ...
    .line 256
    .local v2, "mergedCallbackParameters":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    const-string v5, "callback_params"

    invoke-static {v4, v5, v2}, Lcom/adjust/sdk/PackageBuilder;->addMapJson(Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 262
    .local v3, "mergedPartnerParameters":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    const-string v5, "partner_params"

    invoke-static {v4, v5, v3}, Lcom/adjust/sdk/PackageBuilder;->addMapJson(Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V

    goto :goto_1

    .line 265
    .end local v0    # "activityPackage":Lcom/adjust/sdk/ActivityPackage;
    .end local v2    # "mergedCallbackParameters":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    .end local v3    # "mergedPartnerParameters":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
