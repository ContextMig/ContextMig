...
.method private closeOpenSessions([Ljava/io/File;II)V
    ...
    const-string/jumbo v6, "Closing session: "
...
.method private doCloseSessions(Z)V
    ...
    const-string/jumbo v6, "No open sessions to be closed."
    ...
    const-string/jumbo v6, "Unable to close session. Settings are not loaded."
...
.method private doWriteExternalCrashEvent(Lcom/crashlytics/android/core/internal/models/SessionEventData;)V
    ...
    const-string/jumbo v11, "Tried to write a native crash while no session was open."
    ...
    .line 885
    const-string/jumbo v9, "Failed to flush to session begin file."

    invoke-static {v0, v9}, Lio/fabric/sdk/android/services/common/CommonUtils;->flushOrLog(Ljava/io/Flushable;Ljava/lang/String;)V

    .line 886
    const-string/jumbo v9, "Failed to close fatal exception file output stream."
    ...
    const-string/jumbo v10, "<native-crash [%s (%s)]>"
    ...
    const-string/jumbo v2, "SessionCrash"
    ...
    :cond_2
    :try_start_3
    const-string/jumbo v2, "SessionMissingBinaryImages"
    :try_end_3
    ...
    const-string/jumbo v11, "An error occurred in the native crash logger"
    ...
    :goto_4
    const-string/jumbo v10, "Failed to flush to session begin file."
    ...
    .line 886
    const-string/jumbo v10, "Failed to close fatal exception file output stream."
...
.method private doWriteNonFatal(Ljava/util/Date;Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    const-string/jumbo v4, "Tried to write a non-fatal exception while no session was open."
    ...
    const-string/jumbo v5, "Crashlytics is logging non-fatal exception \""
    ...
    const-string/jumbo v5, "\" from thread "
    ...
    .line 925
    const-string/jumbo v1, "Failed to flush to non-fatal file."
    ...
    const-string/jumbo v4, "An error occurred when trimming non-fatal files."
    ...
    const-string/jumbo v4, "An error occurred in the non-fatal exception logger"
    ...
    .line 926
    const-string/jumbo v3, "Failed to close non-fatal file output stream."
...
.method private retainSessions([Ljava/io/File;Ljava/util/Set;)V
    ...
    const-string/jumbo v10, "Deleting unknown file: "
    ...
    const-string/jumbo v10, "Trimming session file: "
...
.method private synthesizeSessionFile(Ljava/io/File;Ljava/lang/String;[Ljava/io/File;Ljava/io/File;)V
    ...
    const-string/jumbo v9, "CrashlyticsCore"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v11, "Collecting SessionStart data for session ID "
    ...
    .line 1189
    :cond_0
    const-string/jumbo v8, "Error flushing session file stream"
    ...
    :cond_2
    const-string/jumbo v8, "Failed to close CLS file"
    ...
    const-string/jumbo v11, "Failed to write session file for session ID: "
    ...
    :goto_3
    const-string/jumbo v9, "Error flushing session file stream"
    ...
    :cond_4
    const-string/jumbo v9, "Failed to close CLS file"
...
.method private writeBeginSession(Ljava/lang/String;Ljava/util/Date;)V
    ...
    const-string/jumbo v7, "Crashlytics Android SDK/%s"
    ...
    .line 953
    const-string/jumbo v6, "Failed to close begin session file."
...
.method private writeFatal(Ljava/util/Date;Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    const-string/jumbo v3, "An error occurred in the fatal exception logger"
    ...
    .line 818
    const-string/jumbo v2, "Failed to close fatal exception file output stream."
...
.method private static writeNonFatalEventsTo(Lcom/crashlytics/android/core/CodedOutputStream;[Ljava/io/File;Ljava/lang/String;)V
    ...
    const-string/jumbo v8, "Found Non Fatal for session ID %s in %s "
...
.method private writeSessionApp(Ljava/lang/String;)V
    ...
    const-string/jumbo v11, "SessionApp"
    ...
    .line 975
    const-string/jumbo v7, "Failed to flush to session app file."

    invoke-static {v0, v7}, Lio/fabric/sdk/android/services/common/CommonUtils;->flushOrLog(Ljava/io/Flushable;Ljava/lang/String;)V

    .line 976
    const-string/jumbo v7, "Failed to close session app file."
    ...
    :goto_0
    const-string/jumbo v10, "Failed to flush to session app file."

    invoke-static {v0, v10}, Lio/fabric/sdk/android/services/common/CommonUtils;->flushOrLog(Ljava/io/Flushable;Ljava/lang/String;)V

    .line 976
    const-string/jumbo v10, "Failed to close session app file."
...
.method private writeSessionDevice(Ljava/lang/String;)V
    ...
    const-string/jumbo v16, "SessionDevice"
    ...
    :goto_0
    const-string/jumbo v15, "Failed to flush session device info."
    ...
    .line 1024
    const-string/jumbo v15, "Failed to close session device file."
...
.method private writeSessionOS(Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "SessionOS"
    ...
    .line 992
    const-string/jumbo v4, "Failed to flush to session OS file."
    ...
    .line 993
    const-string/jumbo v5, "Failed to close session OS file."
...
.method private writeSessionPartsToSessionFile(Ljava/io/File;Ljava/lang/String;I)V
    ...
    const-string/jumbo v11, "Collecting session parts for ID "
    ...
    const-string/jumbo v10, "SessionCrash"
    ...
    const-string/jumbo v11, "Session %s has fatal exception: %s"
    ...
    const-string/jumbo v10, "SessionEvent"
    ...
    const-string/jumbo v11, "Removing session part files for ID "
    ...
    const-string/jumbo v11, "No events present for session ID "
...
.method private writeSessionUser(Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "SessionUser"
    ...
    .line 1045
    const-string/jumbo v4, "Failed to flush session user file."

    invoke-static {v0, v4}, Lio/fabric/sdk/android/services/common/CommonUtils;->flushOrLog(Ljava/io/Flushable;Ljava/lang/String;)V

    .line 1046
    const-string/jumbo v4, "Failed to close session user file."
    ...
    .line 1046
    const-string/jumbo v5, "Failed to close session user file."
...
.method private static writeToCosFromFile(Lcom/crashlytics/android/core/CodedOutputStream;Ljava/io/File;)V
    ...
    const-string/jumbo v5, "Tried to include a file that doesn\'t exist: "
...
.method doCleanInvalidTempFiles([Ljava/io/File;)V
    ...
    const-string/jumbo v11, "Found invalid session part file: "
    ...
    const-string/jumbo v11, "Moving session file: "
    ...
    const-string/jumbo v11, "Could not move session file. Deleting "
...
.method public declared-synchronized uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    const-string/jumbo v5, "Crashlytics is handling uncaught exception \""
    ...
    const-string/jumbo v4, "An error occurred in the uncaught exception handler"
    ...
    const-string/jumbo v5, "Crashlytics completed exception processing. Invoking default exception handler."
