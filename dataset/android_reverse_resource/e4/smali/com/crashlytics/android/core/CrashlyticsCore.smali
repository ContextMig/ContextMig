...
.method private checkForPreviousCrash()V
    ...
    const-string/jumbo v4, "Exception thrown by CrashlyticsListener while notifying of previous crash."
...
.method private static ensureFabricWithCalled(Ljava/lang/String;)Z
    ...
    const-string/jumbo v4, "Crashlytics must be initialized by calling Fabric.with(Context) "
...
.method private finishInitSynchronously()V
    ...
    const-string/jumbo v7, "Crashlytics detected incomplete initialization on previous app launch. Will initialize synchronously."
...
.method private getSendDecisionFromUser(Landroid/app/Activity;Lio/fabric/sdk/android/services/settings/PromptSettingsData;)Z
    ...
    const-string/jumbo v4, "Waiting for user opt-in."
...
.method protected doInBackground()Ljava/lang/Void;
    ...
    const-string/jumbo v6, "Collection of crash reports disabled in Crashlytics settings."
    ...
    const-string/jumbo v6, "Crashlytics encountered a problem during asynchronous initialization."
...
.method onPreExecute(Landroid/content/Context;)Z
    ...
    .line 255
    const-string/jumbo v6, "com.crashlytics.RequireBuildId"
    ...
    const-string/jumbo v5, "This app relies on Crashlytics. Please sign up for access at https://fabric.io/sign_up,\ninstall an Android build tool and ask a team member to invite you to this app\'s organization."
    ...
    const-string/jumbo v9, "Initializing Crashlytics "
    ...
    const-string/jumbo v7, "crash_marker"
    ...
    const-string/jumbo v7, "initialization_marker"
    ...
    const-string/jumbo v7, "Crashlytics was not started due to an exception during initialization"
...
.method public setString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "Custom attribute key must not be null."
    ...
    const-string/jumbo v3, "Attempting to set custom attribute with null key, ignoring."
    ...
    const-string/jumbo v3, "Exceeded maximum number of custom attributes (64)"
