...
.method public build(Lio/realm/RealmResults;)V
    ...
    check-cast v7, Lio/realm/RealmObject;

    .line 79
    .local v7, "realmObject":Lio/realm/RealmObject;, "TT;"
    new-instance v0, Lio/realm/DynamicRealmObject;

    invoke-direct {v0, v7}, Lio/realm/DynamicRealmObject;-><init>(Lio/realm/RealmObject;)V

    .line 83
    .local v0, "dynamicObject":Lio/realm/DynamicRealmObject;
    :try_start_0
    iget-object v10, p0, Lcom/github/mikephil/charting/data/realm/implementation/RealmBarDataSet;->mValuesField:Ljava/lang/String;

    invoke-virtual {v0, v10}, Lio/realm/DynamicRealmObject;->getFloat(Ljava/lang/String;)F

    move-result v8

    .line 84
    .local v8, "value":F
    iget-object v10, p0, Lcom/github/mikephil/charting/data/realm/implementation/RealmBarDataSet;->mValues:Ljava/util/List;

    new-instance v11, Lcom/github/mikephil/charting/data/BarEntry;

    iget-object v12, p0, Lcom/github/mikephil/charting/data/realm/implementation/RealmBarDataSet;->mIndexField:Ljava/lang/String;

    invoke-virtual {v0, v12}, Lio/realm/DynamicRealmObject;->getInt(Ljava/lang/String;)I

    move-result v12

    invoke-direct {v11, v8, v12}, Lcom/github/mikephil/charting/data/BarEntry;-><init>(FI)V
    ...
    invoke-virtual {v0, v10}, Lio/realm/DynamicRealmObject;->getList(Ljava/lang/String;)Lio/realm/RealmList;

    move-result-object v5

    .line 89
    .local v5, "list":Lio/realm/RealmList;, "Lio/realm/RealmList<Lio/realm/DynamicRealmObject;>;"
    ...
    .line 93
    .local v6, "o":Lio/realm/DynamicRealmObject;
    ...
    invoke-virtual {v6, v10}, Lio/realm/DynamicRealmObject;->getFloat(Ljava/lang/String;)F
    ...
    .line 97
    .end local v6    # "o":Lio/realm/DynamicRealmObject;
    :cond_0
    iget-object v10, p0, Lcom/github/mikephil/charting/data/realm/implementation/RealmBarDataSet;->mValues:Ljava/util/List;
    ...
    invoke-direct {v11, v9, v12}, Lcom/github/mikephil/charting/data/BarEntry;-><init>([FI)V
    ...
    .end local v5    # "list":Lio/realm/RealmList;, "Lio/realm/RealmList<Lio/realm/DynamicRealmObject;>;"
    .end local v7    # "realmObject":Lio/realm/RealmObject;, "TT;"
