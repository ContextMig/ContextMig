...
.method private static appendCsrfToken(Lcom/dropbox/core/DbxWebAuth$Request;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "unexpected CSRF token length: "
    ...
    const-string/jumbo v5, "unexpected combined state length: "
...
.method private static getParam(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v3, "multiple occurrences of \""
...
.method private static verifyAndStripCsrfToken(Ljava/lang/String;Lcom/dropbox/core/DbxSessionStore;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "No CSRF Token loaded from session store."
    ...
    const-string/jumbo v5, "Token retrieved from session store is too small: "
    ...
    const-string/jumbo v5, "Token too small: "
...
.method public finishFromRedirect(Ljava/lang/String;Lcom/dropbox/core/DbxSessionStore;Ljava/util/Map;)Lcom/dropbox/core/DbxAuthFinish;
    ...
    const-string/jumbo v6, "sessionStore"
    ...
    const-string/jumbo v6, "Missing required parameter: \"state\"."
    ...
    const-string/jumbo v6, "Missing both \"code\" and \"error\"."
    ...
    const-string/jumbo v6, "Both \"code\" and \"error\" are set."
    ...
    const-string/jumbo v6, "Both \"code\" and \"error_description\" are set."
    ...
    const-string/jumbo v3, "No additional description from Dropbox"
    ...
    const-string/jumbo v6, "Additional description from Dropbox: "
