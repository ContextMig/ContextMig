...
.method private static createSSLContext([Ljavax/net/ssl/TrustManager;)Ljavax/net/ssl/SSLContext;
    ...
    const-string/jumbo v2, "Couldn\'t create SSLContext"
    ...
    const-string/jumbo v2, "Couldn\'t initialize SSLContext"
...
.method private static createTrustManager()Ljavax/net/ssl/X509TrustManager;
    ...
    .prologue
    .line 203
    const-string/jumbo v1, "/trusted-certs.raw"
...
.method private static createTrustManager(Ljava/security/KeyStore;)Ljavax/net/ssl/X509TrustManager;
    ...
    const-string/jumbo v4, "More than 1 TrustManager created."
    ...
    .line 289
    .local v0, "ex":Ljava/security/NoSuchAlgorithmException;
    const-string/jumbo v3, "Unable to create TrustManagerFactory"
    ...
    const-string/jumbo v3, "Unable to initialize TrustManagerFactory with key store"
    ...
    const-string/jumbo v5, "TrustManager not of type X509: "
...
.method private static deserializeCertificates(Ljava/security/cert/CertificateFactory;Ljava/io/InputStream;)Ljava/util/List;
    ...
    const-string/jumbo v5, "Found data after after zero-length header."
    ...
    const-string/jumbo v6, "Invalid length for certificate entry: "
...
.method private static limitProtocolsAndCiphers(Ljavax/net/ssl/SSLSocket;)V
    ...
    const-string/jumbo v2, "Socket doesn\'t support protocols \"TLSv1.2\", \"TLSv1.0\" or \"TLSv1\"."
...
.method private static loadKeyStore(Ljava/lang/String;)Ljava/security/KeyStore;
    ...
    const-string/jumbo v6, "Couldn\'t find resource \""
    ...
    .line 316
    .local v0, "ex":Ljava/security/KeyStoreException;
    const-string/jumbo v4, "Couldn\'t initialize KeyStore"
    ...
    const-string/jumbo v5, "Error loading from \""
...
.method private static loadKeyStore(Ljava/security/KeyStore;Ljava/io/InputStream;)V
    ...
    const-string/jumbo v7, "Error loading certificate: "
    ...
    const-string/jumbo v5, "Couldn\'t initialize X.509 CertificateFactory"
