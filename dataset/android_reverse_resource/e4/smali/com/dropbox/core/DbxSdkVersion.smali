...
.method private static loadLineFromResource()Ljava/lang/String;
    ...
    const-string/jumbo v6, "/sdk-version.txt"
    ...
    const-string/jumbo v6, "No lines."
    ...
    const-string/jumbo v7, "Found more than one line.  Second line: "
...
.method private static loadVersion()Ljava/lang/String;
    ...
    const-string/jumbo v3, "[0-9]+(?:\\.[0-9]+)*(?:-[-_A-Za-z0-9]+)?"
    ...
    const-string/jumbo v5, "Text doesn\'t follow expected pattern: "
    ...
    const-string/jumbo v5, "Error loading version from resource \"sdk-version.txt\": "
