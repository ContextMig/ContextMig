...
.method private chunkedUploadCommon([Ljava/lang/String;JLcom/dropbox/core/DbxStreamWriter;)Lcom/dropbox/core/http/HttpRequestor$Response;
    ...
    const-string/jumbo v6, "1/chunked_upload"
    ...
    const-string/jumbo v4, "Dropbox-Java-SDK"
    ...
    const-string/jumbo v4, "\'chunkSize\' is "
    ...
    const-string/jumbo v4, ", but \'writer\' only wrote "
...
.method private getMetadataWithChildrenBase(Ljava/lang/String;ZLcom/dropbox/core/json/JsonReader;)Ljava/lang/Object;
    ...
    const-string/jumbo v5, "1/metadata/auto"
...
.method private getMetadataWithChildrenIfChangedBase(Ljava/lang/String;ZLjava/lang/String;Lcom/dropbox/core/json/JsonReader;)Lcom/dropbox/core/util/Maybe;
    ...
    const-string/jumbo v4, "\'previousFolderHash\' must not be null"
    ...
    const-string/jumbo v4, "\'previousFolderHash\' must not be empty"
...
.method public chunkedUploadAppend(Ljava/lang/String;JJLcom/dropbox/core/DbxStreamWriter;)J
    ...
    const-string/jumbo v12, "\'uploadId\' can\'t be null"
    ...
    const-string/jumbo v12, "\'uploadId\' can\'t be empty"
    ...
    const-string/jumbo v12, "\'offset\' can\'t be negative"
    ...
    const-string/jumbo v12, "upload_id"
    ...
    const-string/jumbo v13, "uploadId mismatch: us="
    ...
    const-string/jumbo v13, "Corrected offset is same as given: "
    ...
    const-string/jumbo v13, "we were at offset "
    ...
    const-string/jumbo v13, ", server said "
    ...
    const-string/jumbo v13, "Expected offset "
    ...
    const-string/jumbo v13, " bytes, but returned offset is "
...
.method public chunkedUploadFirst(ILcom/dropbox/core/DbxStreamWriter;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "Got offset correction response on first chunk."
    ...
    const-string/jumbo v5, "Got a 404, but we didn\'t send an upload_id"
    ...
    const-string/jumbo v6, " bytes, but returned offset is "
...
.method public getThumbnail(Lcom/dropbox/core/v1/DbxThumbnailSize;Lcom/dropbox/core/v1/DbxThumbnailFormat;Ljava/lang/String;Ljava/lang/String;Ljava/io/OutputStream;)Lcom/dropbox/core/v1/DbxEntry$File;
    ...
    const-string/jumbo v2, "\'target\' can\'t be null"
...
.method public startGetFile(Ljava/lang/String;Ljava/lang/String;)Lcom/dropbox/core/v1/DbxClientV1$Downloader;
    ...
    const-string/jumbo v3, "1/files/auto"
...
.method public startGetThumbnail(Lcom/dropbox/core/v1/DbxThumbnailSize;Lcom/dropbox/core/v1/DbxThumbnailFormat;Ljava/lang/String;Ljava/lang/String;)Lcom/dropbox/core/v1/DbxClientV1$Downloader;
    ...
    const-string/jumbo v3, "\'size\' can\'t be null"
    ...
    const-string/jumbo v3, "\'format\' can\'t be null"
    ...
    const-string/jumbo v3, "1/thumbnails/auto"
