...
.method public static checkAppBeforeAuth(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v9, "URI scheme in your app\'s manifest is not set up correctly. You should have a "
    ...
    const-string/jumbo v9, " with the scheme: "
    ...
    const-string/jumbo v8, "Security alert"

    invoke-virtual {v1, v8}, Landroid/app/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;

    .line 293
    const-string/jumbo v8, "Another app on your phone may be trying to pose as the app you are currently using. The malicious app can\'t access your account, but linking to Dropbox has been disabled as a precaution. Please contact support@dropbox.com."
    ...
    const-string/jumbo v10, "There are multiple apps registered for the AuthActivity URI scheme ("
    ...
    const-string/jumbo v10, ").  Another app may be trying to  impersonate this app, so authentication will be disabled."
    ...
    const-string/jumbo v9, "There must be a "
    ...
    const-string/jumbo v9, " within your app\'s package registered for your URI scheme ("
    ...
    const-string/jumbo v9, "). However, it appears that an activity in a different package is registered for that scheme instead. If you have multiple apps that all want to use the same accesstoken pair, designate one of them to do authentication and have the other apps launch it and then retrieve the token pair from it."
...
.method private startWebAuth(Ljava/lang/String;)V
    ...
    .line 543
    const-string/jumbo v5, "1/connect"
...
.method protected onNewIntent(Landroid/content/Intent;)V
    ...
    .line 491
    const-string/jumbo v7, "ACCESS_SECRET"
    ...
    .line 493
    const-string/jumbo v7, "AUTH_STATE"
    ...
    .line 501
    :try_start_0
    const-string/jumbo v7, "oauth_token"
    ...
    .line 502
    const-string/jumbo v7, "oauth_token_secret"
...
.method protected onResume()V
    ...
    const-string/jumbo v3, "onResume called again before Handler run"
