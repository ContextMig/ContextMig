...
public class EasyBudgetTest1 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void easyBudgetTest1() {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.amount_edittext),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText.perform(replaceText("45"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withText("Add expense"),
                        isDisplayed()));
        textView.check(matches(withText("Add expense")));
