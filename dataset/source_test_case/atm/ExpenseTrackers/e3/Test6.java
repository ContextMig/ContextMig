...
public class ExpenseTrackerTest6 {
    ...
    public void expenseTrackerTest6() {
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.input_amount),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.input_note),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        editText2.perform(replaceText("income"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.current_money), withText("$ 90.00"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("$ 90.00")));
