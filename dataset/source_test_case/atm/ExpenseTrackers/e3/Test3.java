...
public class ExpenseTrackerTest3 {
    ...
    public void expenseTrackerTest3() {
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.editText),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText.perform(replaceText("books"), closeSoftKeyboard());
        ...
        ViewInteraction editText1 = onView(
                allOf(withId(R.id.editText2),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText1.perform(replaceText("100"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.text1), withText("100  MONTHLY"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.TableLayout.class),
                                        1),
                                0)));
        textView2.check(matches(withText("100  MONTHLY")));
