...
public class ShoppingListTest6 {
    ...
    public void shoppingListTest6() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(android.R.id.title), withText("Rename list"),
                        isDisplayed()));
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.edittext),
                        isDisplayed()));
        editText.perform(replaceText("list2"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(android.R.id.text1), withText("list2"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("list2")));
