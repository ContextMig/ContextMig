...
public class ShoppingListTest7 {
    ...
    public void shoppingListTest7() {
        ...
        onData(anything()).inAdapterView(withId(R.id.lvShoppingList)).
                atPosition(0).onChildView(withId(R.id.nameShoppingList)).check(matches(withText("new-list")));

        onData(anything()).inAdapterView(withId(R.id.lvShoppingList)).
                atPosition(1).onChildView(withId(R.id.nameShoppingList)).check(matches(withText("new-list")));
    }
