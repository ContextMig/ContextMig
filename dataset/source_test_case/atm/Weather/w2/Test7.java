...
public class GoodWeatherTest7 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void goodWeatherTest7() {
        ...
        ViewInteraction textView1 = onView(
                allOf(withId(android.R.id.summary), withText("30 minutes"),
                        isDisplayed()));
        textView1.check(matches(withText("30 minutes")));
